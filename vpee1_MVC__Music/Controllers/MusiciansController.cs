...
namespace vpee1_MVC__Music.Controllers
{
    public class MusiciansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MusicianID,FirstName,MiddleName,LastName,PhoneNumber,name,SIN,InstrumentID")] Musician musician)
        {
            ...
            ViewData["InstrumentID"] = new SelectList(_context.Instruments, "InstrumentID", "Name", musician.InstrumentID);
            return View(musician);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MusicianID,FirstName,MiddleName,LastName,PhoneNumber,DOB,SIN,InstrumentID")] Musician musician)
        {
